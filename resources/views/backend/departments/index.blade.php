...
@section('main-content')
                        ...
                        <div class="col-sm-12">
                            ...
                            <form action="{{ route('departments.store') }}" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 @error('deptcode') has-error @enderror">
                                        <input type="text" class="form-control" name="deptcode"
                                            value="{{ old('deptcode') }}" placeholder="deptcode">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 @error('deptname') has-error @enderror">
                                        <input type="text" class="form-control" name="deptname"
                                            value="{{ old('deptname') }}" placeholder="deptname">
                                ...
                                <td>
                                    <div class="btn-group btn-corner">
                                        ...
                                        @if (hasPermission(['editor', 'creator']))
                                            <a href="#edit{{ $item->deptcode }}" role="button" data-toggle="modal"
                                        ...
                                        @if (hasPermission('creator'))
                                            <button type="button"
                                                onclick="delete_item(`{{ route('departments.destroy', $item->deptcode) }}`)"
    ...
    @foreach ($depts as $item)
        ...
        <div id="edit{{ $item->deptcode }}" class="modal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <form action="{{ route('departments.update', $item->deptcode) }}" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 @error('deptcode') has-error @enderror">
                                            <input type="text" class="form-control" name="deptcode"
                                                value="{{ old('deptcode', $item->deptcode) }}" placeholder="deptcode">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 @error('deptname') has-error @enderror">
                                            <input type="text" class="form-control" name="deptname"
                                                value="{{ $item->deptname ?: old('deptname') }}" placeholder="deptname">

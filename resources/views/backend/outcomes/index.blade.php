...
@section('main-content')
    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xs-12">
                @include('backend.outcomes.create-modal')
                @include('backend.outcomes.edit-modal')
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-corner">
                                            <a href="#editModal" onclick="editModal(`{{ $item->name }}`,`{{ route('outcomes.destroy', $item->id) }}`)" 
                                             role="button" data-toggle="modal"
                                                class="btn btn-sm btn-success" title="Edit">
                                                <i class="fa fa-pencil-square-o"></i>
                                            </a>
                                            <a class="btn btn-sm btn-danger" href="#"
                                                onclick="delete_item(`{{ route('outcomes.destroy', $item->id) }}`)"

                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="text" name="name" autocomplete="off"
                                        value="{{ old('name', $student->name) }}" placeholder="Course Name" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="text" name="email" autocomplete="off"
                                        value="{{ old('email', $student->email) }}" placeholder="Type email" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="text" name="student_id" autocomplete="off"
                                        value="{{ old('student_id', $student->student_id) }}" placeholder="Type ID" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="text" name="phone" autocomplete="off"
                                        value="{{ old('phone', $student->phone) }}" placeholder="Type phone" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="text" name="batch"
                                        value="{{ old('batch', $student->batch) }}" placeholder="batch" />
                                </div>
                            </div>
